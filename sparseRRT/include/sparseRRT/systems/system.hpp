...
#include "sparseRRT/image_creation/svg_image.hpp"
...
public: 
    ...
    //overwrited by sst planner
    virtual bool obstacles_in_goal()
    {
      return true;
    }
    virtual bool obstacles_in_goal(double x, double y, double z)
    {
      return true;
    }
    //overwrited by sst planner
    virtual bool obstacles_in_start()
    {
      return true;
    }
    virtual bool obstacles_in_start(double x, double y, double z)
    {
      return true;
    }
    //overwrited by sst planner
    virtual bool change_Map_Limits(double abs_x, double abs_y, double min_z, double max_z)
    {
      return true;
    }
