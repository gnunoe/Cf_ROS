...
public:
       ...
       Rectangle_3D(double pos_x, double pos_y, double pos_z,
                    double dim_x, double dim_y, double dim_z)
       {
                low_3x = pos_x-dim_x/2;
                low_3y = pos_y-dim_y/2;
                low_3z = pos_z-dim_z/2;
                high_3x = pos_x+dim_x/2;
                high_3y = pos_y+dim_y/2;
                high_3z = pos_z+dim_z/2;
       }
