...
#include "sparseRRT/motion_planners/tree_node.hpp"
...
public: 
	...
	/**
         * @brief Get the shortest path between two nodes in an already built tree.
         * @details Get the shortes path between two nodes in an already built tree searching which
         * is the closer node which connects the start and the goal points.
         * 
         * @param x_s first coordinate of the start point.
         * @param y_s second coordinate of the start point.
         * @param z_s third coordinate of the start point.
         * @param x_g first coordinate of the goal point.
	 * @param y_g second coordinate of the goal point.
         * @param z_g third coordinate of the goal point.
	 * @param smooth include or avoid the smooth step.
	 *
	 * @return true if the trajectory has been found, false if not.
         */
