...
{
  params::integration_step=.01;
  params::stopping_type="time";
  params::stopping_check=30;
  params::stats_type = "time";
  params::stats_check = 15;
  params::min_time_steps=30;    //30    
  params::max_time_steps=50;    //50
  params::random_seed= 0;
  params::sst_delta_near=.3; //.3;   //.4;    //.1
  params::sst_delta_drain=.05; //.05;  //.01;
  params::planner="sst";
  params::system="quadrotor_cf";
  params::start_state=new double[12];
  params::goal_state= new double[12];
  params::start_state[0]=2;
  params::start_state[1]=2;
  params::start_state[2]=1;
  params::start_state[3]=0;
  params::start_state[4]=0;
  params::start_state[5]=0;
  params::start_state[6]=0;
  params::start_state[7]=0;
  params::start_state[8]=0;
  params::start_state[9]=0;
  params::start_state[10]=0;
  params::start_state[11]=0;

  params::goal_state[0]=-2;
  params::goal_state[1]=-2;
  params::goal_state[2]=1;
  params::goal_state[3]=0;
  params::goal_state[4]=0;
  params::goal_state[5]=0;
  params::goal_state[6]=0;
  params::goal_state[7]=0;
  params::goal_state[8]=0;
  params::goal_state[9]=0;
  params::goal_state[10]=0;
  params::goal_state[11]=0;

  params::goal_radius=.25;
  ...
  params::image_height=1000;
  params::node_diameter=5;
  params::solution_node_diameter=10;

  
  //Map parameters
  params::map = "";
  params::path_file = "";
  params::availableSolution = false;
  ...
  /*
	...
	("stopping_check",po::value<unsigned>(&params::stopping_check),"Amount of time or iterations to execute.") 
	("stats_type",po::value<std::string>(&params::stats_type),"Condition for printing statistics of a planner (iterations or time).") 
	("stats_check",po::value<unsigned>(&params::stats_check),"Frequency of statistics gathering.") 
