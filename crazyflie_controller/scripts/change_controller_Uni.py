...
class Controller():
    ...
    def __init__(self):
        ...
        self.pidX = PID(10, 2.0, 0.0, -10, 10, "x")
        self.pidY = PID(-10, -2.0, 0.0, -10, 10, "y")
        #50000  800
        self.pidZ = PID(15000, 3000.0,  1500.0, 10000, 60000, "z")
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            if self.state == Controller.TakeOff:
                t = self.listener.getLatestCommonTime("/mocap", "/Nano_Mark_Uni1")
                if self.listener.canTransform("/mocap", "/Nano_Mark_Uni1", t):
                    position, quaternion = self.listener.lookupTransform("/mocap","/Nano_Mark_Uni1", t)
